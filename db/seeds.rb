...
product1 = Product.create!({title: "Pikachu Plush", description: "Hand made pikachu plush. 20 inches tall. Great for kids or decorating a gaming room!", price: 9.99, seller_id: user1.id})

product1.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/pikachu_plush.jpg"), filename: "1.jpg")

product2 = Product.create!({title: 'Ceramic Mug', description: 'Hand crafted ceramic mug. Made on order. Choose customizations such as initials or images you would like printed on the side. Choose from many styles!', price: 5.49, seller_id: user2.id})
...
product4 = Product.create!({title: 'Painting', description: 'Choose from a painting template or message a request for a custom painting. Choose size.', price: 15.99, seller_id: user4.id})

product4.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/painting.jpg"), filename: "4.jpg")

product5 = Product.create!({title: 'Necklace', description: 'Hand crafted necklace with you choice of charm. Select chain material and color.', price: 35.00, seller_id: user5.id} )

product5.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/necklace.jpg"), filename: "5.jpg")

product6 = Product.create!({title: 'Ring', description: 'Hand made ring with your choice of metal and gemstone. Select size. Message about customization requests.', price: 49.99, seller_id: user1.id} )

product6.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/ring.jpg"), filename: "6.jpg")

product7 = Product.create!({title: 'Tshirt', description: 'Choose an image you want printed on the tshirt or submit a request for a personal design. Select size.', price: 10.99, seller_id: user2.id} )

product7.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/Shirt.jpg"), filename: "7.jpg")

product8 = Product.create!({title: 'Wooden Sign', description: 'Hand made wooden sign with your choice of message. Choose a size!', price: 21.49, seller_id: user3.id} )
...
product10 = Product.create!({title: 'Action Figure', description: 'Select one from many choices of hand made action figures. Select model below!', price: 10.00, seller_id: user5.id} )

product10.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/action_figure.jpg"), filename: "10.jpg")

product11 = Product.create!({title: 'Slippers', description: 'Be comfy at home with a pair of our custom desgined slippers. Choose your size and design!', price: 18.89, seller_id: user1.id} )

product11.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/slippers.jpg"), filename: "11.jpg")

product12 = Product.create!({title: 'Watch', description: 'Select from one of our many styles of hand made watches. Be the most fashionable or just choose what you think suits you best!', price: 119.99, seller_id: user2.id} )
...
product14 = Product.create!({title: 'Braclet', description: 'Select the style of bracelet and how you would like it customized to fit you!', price: 25.49, seller_id: user4.id} )

product14.photo.attach(io: URI.open("https://imadethis-seeds.s3.us-east-2.amazonaws.com/bracelet.jpg"), filename: "14.jpg")

product15 = Product.create!({title: 'Wallet', description: 'Choose the type of material and style that fits you best. Request extra customizations like initals!', price: 59.99, seller_id: user5.id} )
